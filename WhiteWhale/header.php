...
<head>
	...
	<!--<link rel='stylesheet' href="<?php echo get_template_directory_uri(); ?>/css/style_sp.css" media='all and (max-width:460px)'>-->
	<link rel='stylesheet' href="<?php echo get_stylesheet_directory_uri(); ?>/css/style_sp.css" media='all and (max-width:460px)'>
	<!--<link rel='stylesheet' href="<?php echo get_template_directory_uri(); ?>/css/style_tab.css" media='all and (min-width:460px) and (max-width:768px)'>-->
	...
	<!--<link rel='stylesheet' href="<?php echo get_template_directory_uri(); ?>/css/style_pc.css" media='all and (min-width:768px)'>-->
